...
import { TBurgerConstructorProps } from "../../utils/types";

const BurgerIngredients: FunctionComponent<TBurgerConstructorProps> = ({ onOpenModal }) => {
  const [tab, setCurrentTab] = useState<string>("bun");
